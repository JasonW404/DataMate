package com.datameta.collection.interfaces.rest;

import com.datameta.collection.application.service.CollectionTaskService;
import com.datameta.collection.application.service.TaskExecutionService;
import com.datameta.collection.domain.model.TaskExecution;
import com.datameta.collection.interfaces.api.TaskExecutionApi;
import com.datameta.collection.interfaces.dto.PagedTaskExecutions;
import com.datameta.collection.interfaces.dto.TaskExecutionDetail;
import com.datameta.collection.interfaces.dto.TaskExecutionResponse;
import com.datameta.collection.interfaces.dto.TaskStatus; // DTO enum
...
public class TaskExecutionController implements TaskExecutionApi {
    ...
    public ResponseEntity<TaskExecutionResponse> tasksIdExecutePost(String id) {
        ...
        if (latestExec != null && latestExec.getStatus() == com.datameta.collection.domain.model.TaskStatus.RUNNING) {
