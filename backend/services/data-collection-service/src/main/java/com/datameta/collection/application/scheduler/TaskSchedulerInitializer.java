package com.datameta.collection.application.scheduler;

import com.datameta.collection.application.service.DataxExecutionService;
import com.datameta.collection.domain.model.CollectionTask;
import com.datameta.collection.domain.model.TaskStatus;
import com.datameta.collection.domain.model.TaskExecution;
import com.datameta.collection.infrastructure.persistence.mapper.CollectionTaskMapper;
import com.datameta.collection.infrastructure.persistence.mapper.TaskExecutionMapper;
...
public class TaskSchedulerInitializer {
    ...
    @Scheduled(fixedDelayString = "${datameta.data-collection.scheduler.scan-interval-ms:10000}")
